...
def visualize_tab(tab_file_dir, model_name, method_name):
    ...
    print(os.path.exists(tab_file_dir))
    data = pickle.load(f)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_gt_trees', default=True, help='whether use ground truth parsing trees (sst)'
                                               'if true, --file should be .txt', action='store_true')
    parser.add_argument('--gt_tree_path', default='.data/sst/trees/%s.txt' % 'dev')
