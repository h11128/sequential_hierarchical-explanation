...
""" 
command for soc sst bert
python explain.py --resume_snapshot models/models/sst_bert --method soc --lm_path models/models/sst_lstm_lm --batch_size 1 --start 0  --stop 50 --exp_name .sst_demo2 --task sst --explain_model lstm --nb_range 10 --sample_n 20 --use_bert_tokenizer
"""
